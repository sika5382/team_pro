...
<script type="text/javascript">
  ...
  // writer.innerHTML='dddd';
   window.addEventListener('ready', function(writer){document.getElementById("writer").innerHTML='dddd';})
...
<title>글쓰기창</title>
 ...
 <body>
    ...
    <section class="py-5">
      ...
      </div><img class="w-100 py-5" src="/team/resources/img/post-banner.jpg" alt="">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mb-5 mb-lg-0">
			...
			<!-- 작성폼 -->
			<form class="mb-5" action="<%=request.getContextPath() %>/board/writeSave" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="form-group col-lg-8">
                  <h6>장소명</h6><input class="form-control" type="text" id="place_name" name="place_name" placeholder="차박장소명을 입력해주세요">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-lg-8">
                  <h6>주소</h6><input class="form-control" type="text" id="place_addr"name="place_addr" placeholder="해당 장소의 주소지를 입력해주세요">
                </div>
              </div>
              <div class="row">
              	<div class="form-group col-lg-8">
                  <h6>비용</h6><input class="form-control" type="text" id="price"name="price" placeholder="해당 장소의 이용비용을 입력해주세요">
                </div>
              </div>
              <div class="row">
              	<div class="form-group col-lg-8">
                  <h6>기타 편의시설</h6><input class="form-control" type="text" id="place_etc"name="place_etc" placeholder="화장실, 와이파이 등 기타 편의시설을 입력해주세요">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-lg-8">
                  <h6>후기</h6><textarea class="form-control" name="review" rows="5" placeholder="솔직한 이용후기를 남겨주세요"></textarea>
                </div>
