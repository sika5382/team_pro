        ...
        <div class="row mb-5">
				...
				<div class="col-lg-6 mb-5">
					...
					<ul class="list-inline small text-uppercase mb-0">
					 <li class="list-inline-item align-middle mr-0"><a class="font-weight-bold reset-anchor" href="#">No. ${dto.write_no}</a></li>	
						 <li class="list-inline-item mr-0 text-gray align-middle">By ${dto.id }</li>
						 <li class="list-inline-item text-gray align-middle">${dto.savedate }</li>	
					</ul>
					  <h3 class="h4 mt-2"> <a class="reset-anchor" href="post.html">${dto.title}</a></h3><a class="reset-anchor text-gray text-uppercase small mb-2 d-block" href="#">Travel guide</a>
               		 <p class="text-small mb-1">${dto.content }</p><a class="btn btn-link" href="index.html">Continue reading</a>
          ...
          <div class="col-lg-4">
            ...
            <div class="mb-5 text-center"><img class="mb-3 rounded-circle img-thumbnail shadow-sm" src="/team/resources/img/author.jpg" alt="" width="110">
              ...
              <p class="text-small text-muted px-sm-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p><img class="d-block mx-auto mb-3" src="/root/resources/img/signature.png" alt="" width="60">
