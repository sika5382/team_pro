...
<body>
    ...
    <header class="header">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white py-4">
        <div class="container text-center"><a class="navbar-brand mx-auto" href="index.html"><img class="mb-2" src="resources/img/logo.svg" alt="" width="140">
          ...
          <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
              <li class="nav-item px-1">
                <!-- Link--><a class="nav-link" href="index">Home</a>
              </li>
              <li class="nav-item px-1">
                <!-- Link--><a class="nav-link active" href="listing">Listing</a>
              </li>
              <li class="nav-item px-1">
                <!-- Link--><a class="nav-link" href="post">Post</a>
              </li>
               <li class="nav-item px-1">
                <!-- Link--><a class="nav-link" href="post">Login</a>
              </li>
        ...
        <div class="row mb-5">
          <div class="col-lg-8">
			...
			<c:set var="contextPath" value="${pageContext.request.contextPath}" />
				...
				<tr><th colspan="9">등록된 글이 없습니다.</th></tr>
				</c:if>
				
				<c:forEach items="${boardList}" var="dto">
					<img src="${path }/download?imageFileName=${imageFileName}"
					 <li class="list-inline-item mr-0 text-gray align-middle">By </li>
                  	 <li class="list-inline-item align-middle mr-0"><a class="font-weight-bold reset-anchor" href="#">${dto.id }</a></li>										style="width:150px;">
					 <a href="${contextPath }/board/contentView?write_no=${dto.write_no}">${dto.title}</a>
              ...
              <div class="col-lg-6 mb-5"><a href="post.html"><img class="img-fluid mb-4" src="resources/img/listing-tnumbnail-3.jpg" alt=""/></a>
              ...
              <div class="col-lg-6 mb-5"><a href="post.html"><img class="img-fluid mb-4" src="resources/img/listing-tnumbnail-4.jpg" alt=""/></a>
                <ul class="list-inline small text-uppercase mb-0">
                  <li class="list-inline-item mr-0 text-gray align-middle">By </li>
              ...
              <div class="col-lg-6 mb-5"><a href="post.html"><img class="img-fluid mb-4" src="resources/img/listing-tnumbnail-1.jpg" alt=""/></a>
                <ul class="list-inline small text-uppercase mb-0">
                  <li class="list-inline-item mr-0 text-gray align-middle">By </li>
                  <li class="list-inline-item align-middle mr-0"><a class="font-weight-bold reset-anchor" href="#">Jimmy Roy</a></li>
                  <li class="list-inline-item text-gray align-middle mr-0">|</li>
              ...
              <div class="col-lg-6 mb-5"><a href="post.html"><img class="img-fluid mb-4" src="resources/img/listing-tnumbnail-2.jpg" alt=""/></a>
                <ul class="list-inline small text-uppercase mb-0">
                  <li class="list-inline-item mr-0 text-gray align-middle">By </li>
                  <li class="list-inline-item align-middle mr-0"><a class="font-weight-bold reset-anchor" href="#">Jason Doe</a></li>
                  <li class="list-inline-item text-gray align-middle mr-0">|</li>
              ...
              <div class="col-lg-6 mb-5"><a href="post.html"><img class="img-fluid mb-4" src="resources/img/listing-tnumbnail-5.jpg" alt=""/></a>
                <ul class="list-inline small text-uppercase mb-0">
                  <li class="list-inline-item mr-0 text-gray align-middle">By </li>
                  <li class="list-inline-item align-middle mr-0"><a class="font-weight-bold reset-anchor" href="#">Jimmy Roy</a></li>
                  <li class="list-inline-item text-gray align-middle mr-0">|</li>
              ...
              <div class="col-lg-6 mb-5"><a href="post.html"><img class="img-fluid mb-4" src="resources/img/listing-tnumbnail-6.jpg" alt=""/></a>
                <ul class="list-inline small text-uppercase mb-0">
                  <li class="list-inline-item mr-0 text-gray align-middle">By </li>
                  <li class="list-inline-item align-middle mr-0"><a class="font-weight-bold reset-anchor" href="#">Jason Doe</a></li>
                  <li class="list-inline-item text-gray align-middle mr-0">|</li>
          ...
          <div class="col-lg-4">
            ...
            <div class="mb-5 text-center"><img class="mb-3 rounded-circle img-thumbnail shadow-sm" src="img/author.jpg" alt="" width="110">
              ...
              <p class="text-small text-muted px-sm-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p><img class="d-block mx-auto mb-3" src="resources/img/signature.png" alt="" width="60">
            ...
            <!-- Categories widget -->
            <div class="mb-5 text-center"><a class="category reset-anchor bg-cover bg-center mb-2" href="#" style="background: url(resources/img/category-1.jpg)">
                <p class="category-title text-uppercase small">Lifestyle</p></a><a class="category reset-anchor bg-cover bg-center mb-2" href="#" style="background: url(resources/img/category-2.jpg)">
                <p class="category-title text-uppercase small">Travel</p></a><a class="category reset-anchor bg-cover bg-center" href="#" style="background: url(resources/img/category-3.jpg)">
            ...
            <div class="mb-5">
              ...
              <ul class="list-unstyled">
                <li class="media mb-1"><a href="post.html"><img src="resources/img/recent-posts-thumb-1.jpg" alt="" width="80"></a>
                ...
                <li class="media mb-1"><a href="post.html"><img src="resources/img/recent-posts-thumb-2.jpg" alt="" width="80"></a>
                  <div class="media-body ml-3">
                    <p class="small text-primary text-uppercase mb-0">5 Aug 2018</p>
                ...
                <li class="media"><a href="post.html"><img src="resources/img/recent-posts-thumb-3.jpg" alt="" width="80"></a>
                  <div class="media-body ml-3">
                    <p class="small text-primary text-uppercase mb-0">5 Aug 2018</p>
            ...
            <div class="mb-5">
              ...
              <div class="row px-3">
                <div class="col-3 px-0"><a class="instagram-item overlay-hover-dark-sm d-block w-100" href="#">
                    <div class="overlay-content"><img class="img-fluid" src="resources/img/instagram-1.jpg" alt=""></div></a></div>
                <div class="col-3 px-0"><a class="instagram-item overlay-hover-dark-sm d-block w-100" href="#">
                    <div class="overlay-content"><img class="img-fluid" src="resources/img/instagram-2.jpg" alt=""></div></a></div>
                <div class="col-3 px-0"><a class="instagram-item overlay-hover-dark-sm d-block w-100" href="#">
                    <div class="overlay-content"><img class="img-fluid" src="resources/img/instagram-3.jpg" alt=""></div></a></div>
                <div class="col-3 px-0"><a class="instagram-item overlay-hover-dark-sm d-block w-100" href="#">
                    <div class="overlay-content"><img class="img-fluid" src="resources/img/instagram-4.jpg" alt=""></div></a></div>
                <div class="col-3 px-0"><a class="instagram-item overlay-hover-dark-sm d-block w-100" href="#">
                    <div class="overlay-content"><img class="img-fluid" src="resources/img/instagram-5.jpg" alt=""></div></a></div>
                <div class="col-3 px-0"><a class="instagram-item overlay-hover-dark-sm d-block w-100" href="#">
                    <div class="overlay-content"><img class="img-fluid" src="resources/img/instagram-6.jpg" alt=""></div></a></div>
                <div class="col-3 px-0"><a class="instagram-item overlay-hover-dark-sm d-block w-100" href="#">
                    <div class="overlay-content"><img class="img-fluid" src="resources/img/instagram-8.jpg" alt=""></div></a></div>
                <div class="col-3 px-0"><a class="instagram-item overlay-hover-dark-sm d-block w-100" href="#">
                    <div class="overlay-content"><img class="img-fluid" src="resources/img/instagram-1.jpg" alt=""></div></a></div>
              </div>
            </div>
