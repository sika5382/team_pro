    ...
    <header class="header">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white py-4">
        <div class="container text-center"><a class="navbar-brand mx-auto" href="index.html"><img class="mb-2" src="resources/img/logo.svg" alt="" width="140">
            <p class="text-small text-uppercase text-gray mb-0">당신의 단 하나뿐인 여행가이드</p></a></div>
      </nav>
      <!-- Navbar 2 -->
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item px-1">
                <!-- Link--><a class="nav-link" href="listing">Listing</a>
              </li>
              <li class="nav-item px-1">
                <!-- Link--><a class="nav-link active" href="post">Post</a>
              </li>
               <li class="nav-item px-1">
    ...
    <section class="py-5">
      <div class="container text-center">
        ...
        <ul class="list-inline small text-uppercase mb-0">
          <li class="list-inline-item align-middle"><img class="rounded-circle shadow-sm" src="resources/img/person-1.jpg" alt="" width="40"/></li>
      ...
      </div><img class="w-100 py-5" src="resources/img/post-banner.jpg" alt="">
      <div class="container">
        <div class="row">
            ...
            <ul class="list-unstyled comments">
              <li>
                <div class="d-flex mb-4">
                  <div class="pr-2 flex-grow-1" style="width: 75px; min-width: 75px;"><img class="rounded-circle shadow-sm img-fluid img-thumbnail" src="resources/img/person-1.jpg" alt=""></div>
                  <div class="pl-2">
                ...
                <ul class="list-unstyled">
                  <li> 
                    <div class="d-flex mb-4">
                      <div class="pr-2 flex-grow-1" style="width: 75px; min-width: 75px;"><img class="rounded-circle shadow-sm img-fluid img-thumbnail" src="resources/img/person-2.jpg" alt=""></div>
                      <div class="pl-2">
              ...
              <li>
                <div class="d-flex mb-4">
                  <div class="pr-2 flex-grow-1" style="width: 75px; min-width: 75px;"><img class="rounded-circle shadow-sm img-fluid img-thumbnail" src="resources/img/person-3.jpg" alt=""></div>
                  <div class="pl-2">
          ...
          <div class="col-lg-4">
            <!-- About me widget -->
            <div class="mb-5 text-center"><img class="mb-3 rounded-circle img-thumbnail shadow-sm" src="resources/img/author.jpg" alt="" width="110">
